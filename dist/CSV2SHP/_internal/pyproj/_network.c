...
static int __Pyx_modinit_variable_import_code(void) {
  ...
  __Pyx_GOTREF(__pyx_t_1);
  if (__Pyx_ImportVoidPtr_3_0_11(__pyx_t_1, "PYPROJ_GLOBAL_CONTEXT", (void **)&__pyx_vp_6pyproj_8_datadir_PYPROJ_GLOBAL_CONTEXT, "PJ_CONTEXT *") < 0) __PYX_ERR(2, 1, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
  __Pyx_RefNannyFinishContext();
  return 0;
  __pyx_L1_error:;
